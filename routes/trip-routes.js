...
import snoozeController from '../controllers/snooze-controller.js';
import tripValidators from '../validators/trip-validator.js';
import snoozeValidators from '../validators/snooze-validator.js';
...
router.post(
    '/:tripId/snooze',
    protect,
    snoozeValidators.snooze,
    validate,
    snoozeController.snooze
);

router.patch(
    '/:tripId/resume',
    protect,
    snoozeValidators.resume,
    validate,
    snoozeController.resume
);
